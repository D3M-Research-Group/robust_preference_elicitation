...
img_dir = '/Users/duncan/research/ActivePreferenceLearning/RobustActivePreferenceLearning_output/fig/v0/'

# results file (from static elicitation experiments)
output_file = '/Users/duncan/research/ActivePreferenceLearning/RobustActivePreferenceLearning_output/gold/static_experiment_20191218_083950.csv'
...
for i_col in range(len(num_items_list)):
    ...
    ax.set_title("num items = {}".format(num_items_list[i_col]))
...
for i_col in range(len(num_features_list)):
    ...
    ax.set_title("num features = {}".format(num_features_list[i_col]))
...
for i_col in range(len(gamma_list)):
    ...
    ax.set_title("gamma = {}".format(gamma_list[i_col]))
...
axs[0, 0].legend()
plt.tight_layout()
plt.savefig(os.path.join(img_dir, 'objval_v0.pdf'))
...
plt.savefig(os.path.join(img_dir, 'prob_random_wins_v0.pdf'))
...
plt.savefig(os.path.join(img_dir, 'runtime_v0.pdf'))