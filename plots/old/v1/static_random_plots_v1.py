...
img_dir = '/Users/duncan/research/ActivePreferenceLearning/RobustActivePreferenceLearning_output/fig/compare_to_random_v1/'

# results file (from static elicitation experiments)
output_file = '/Users/duncan/research/ActivePreferenceLearning/RobustActivePreferenceLearning_output/gold/v1/static_experiment_20200104_124107.csv'
...
plt.savefig(os.path.join(img_dir, 'objval_v1.pdf'))
...
plt.savefig(os.path.join(img_dir, 'prob_random_wins_v1.pdf'))
...
plt.savefig(os.path.join(img_dir, 'runtime_v1.pdf'))