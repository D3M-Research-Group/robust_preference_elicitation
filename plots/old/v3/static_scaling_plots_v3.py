...
# python -m experiments.static_experiment --max-K 10 --num-random-samples 1 --gamma 0.0 0.05 0.1 0.2 --num-items 40 20 60
...
img_dir = '/Users/duncan/research/ActivePreferenceLearning/RobustActivePreferenceLearning_output/fig/scaling_{}/'.format(version_str)

# results file (from static elicitation experiments)
output_file = '/Users/duncan/research/ActivePreferenceLearning/RobustActivePreferenceLearning_output/gold/{}/static_experiment_20200106_165501.csv'.format(version_str)
